...
export class DataShareProvider {
  ...
  checkboxed: any[] = [];
  lextale_instructions: string;
  lextale_items: object[];

  constructor(public storage: Storage) {
    this.the_items = this.german_items;
    this.allpossiblewords = this.the_items.meaningful.concat(this.the_items.pseudo).sort();
    this.lextale_instructions = this.lextale_instructions_en;
    this.lextale_items = this.lextale_items_de;
  }
