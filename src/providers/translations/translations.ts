    ...
    'en': (targs, nontargs, trefs, nontrefs, cittype) => {
      ...
      if (cittype !== 1) {
        ...
        if (cittype === 0) {
          ...
          thetexts.push(
            "<span id='feedback_id3'>In this third and last practice round all items are present. You again have to respond fast, but a certain rate of error is allowed. The task is the same, touch the left button when you see the following item: " + targs + trefs + "<br>Touch the right button for everything else.</span>");
        } else {
        ...
        thetexts.push("<span id='feedback_id3'>Now, in this second and last practice round, you have to respond fast, but a certain rate of error is allowed. The task is the same, touch the left button when you see the following item: " + targs + trefs + "<br>Touch the right button for everything else.</span>");
      }
